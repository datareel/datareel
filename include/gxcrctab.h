...
CRC 32 table of all possible single-byte values. The table is
the CRC of all possible eight bit values. This is all the info
needed to generate 32-bit CRC's on data one a byte at a time 
for all combinations of CRC register values and incoming bytes.   
This table was generated with the makeCRC32() function. It is
...
*/
// ----------------------------------------------------------- //   
#ifndef __GX_CRC32_TABLE_HPP__
#define __GX_CRC32_TABLE_HPP__
